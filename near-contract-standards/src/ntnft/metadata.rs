...
pub const NTNFT_METADATA_SPEC: &str = "nft-1.0.0";

/// Metadata for the NFT contract itself.
#[derive(BorshDeserialize, BorshSerialize, Serialize, Deserialize, Clone, Debug, PartialEq)]
#[serde(crate = "near_sdk::serde")]
pub struct NTNFTContractMetadata {
...
pub trait NTNFTMetadataProvider {
    fn ntnft_metadata(&self) -> NTNFTContractMetadata;
}

impl NTNFTContractMetadata {
    pub fn assert_valid(&self) {
        require!(self.spec == NTNFT_METADATA_SPEC, "Spec is not NFT metadata");
        require!(
